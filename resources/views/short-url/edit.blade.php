...
@section('content')
    <div class="container p-4 mx-auto bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">

        <h3 class="mb-3 text-lg text-bold">#Update Code: {{ $model->code }}</h3>
        <form method="POST" action="{{ route('short-url.short-url.update', $model->id) }}">
            @csrf
            @method('PUT')
